...
import {
  ...
  ShieldAlert, Terminal, Zap, Grid3x3, BookOpenText, CandlestickChart
} from "lucide-react";
...
const navItems = [
  ...
  { path: "/journal", icon: BookOpenText, label: "Trade Journal", shortcut: "J" },
  { path: "/charts", icon: CandlestickChart, label: "Charts", shortcut: "C" },
